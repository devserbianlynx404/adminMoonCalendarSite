                            ...
                            <div class="table-responsive">
                                <table class="table table-hover product_item_list c_table theme-color mb-0">
                                    ...
                                    <tr>
                                        ...
                                        <th data-breakpoints="sm xs md">Заголовок</th>
                                        <th data-breakpoints="sm xs md">Дата изменения</th>
                                        <th>Действие</th>
                                    </tr>
                                    </thead>
                                    <tbody>
                                    @foreach($lunar_zodiacs_data as $lunar_zodiac)
                                        <tr>
                                            <td>{{$lunar_zodiac['id']}}</td>
                                            <td>{{$lunar_zodiac['name']}}</td>
                                            <td>{!! $lunar_zodiac['short_description'] !!}</td>
                                            <td>{{$lunar_zodiac['title']}}</td>
                                            <td>{{$lunar_zodiac['updated_at']}}</td>
                                            <td>
                                                <a href="/lunar-zodiac/edit/{{$lunar_zodiac['id']}}" class="js_click_update_day btn btn-default waves-effect waves-float btn-sm waves-green"><i class="zmdi zmdi-edit"></i></a>
