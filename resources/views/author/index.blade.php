@extends('layouts.app')
@section('title', 'Список астрологов')
@section('content')
                                ...
                                <table class="table table-hover product_item_list c_table theme-color mb-0">
                                    ...
                                    @foreach($author_data as $author)
                                        <tr>
                                            ...
                                            <td>
                                                <a href="/author/edit/{{$author['id']}}" class="js_click_update_day btn btn-default waves-effect waves-float btn-sm waves-green"><i class="zmdi zmdi-edit"></i></a>
