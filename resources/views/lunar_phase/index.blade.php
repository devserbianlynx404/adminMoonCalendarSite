                            ...
                            <div class="table-responsive">
                                <table class="table table-hover product_item_list c_table theme-color mb-0">
                                    ...
                                    <tr>
                                        ...
                                        <th data-breakpoints="sm xs md">Фаза</th>
                                        <th data-breakpoints="sm xs md">Дата изменения</th>
                                        <th>Действие</th>
                                    </tr>
                                    </thead>
                                    <tbody>
                                    @foreach($lunar_phases_data as $lunar_phase)
                                        <tr>
                                            <td>{{$lunar_phase['id']}}</td>
                                            <td>{{$lunar_phase['name']}}</td>
                                            <td>{!! $lunar_phase['short_description'] !!}</td>
                                            <td>{{$lunar_phase['phase_number']}}</td>
                                            <td>{{$lunar_phase['updated_at']}}</td>
                                            <td>
                                                <a href="/lunar-phase/edit/{{$lunar_phase['id']}}" class="js_click_update_day btn btn-default waves-effect waves-float btn-sm waves-green"><i class="zmdi zmdi-edit"></i></a>
