        ...
        <div class="block-header">
            <div class="row">
                <div class="col-lg-7 col-md-6 col-sm-12">
                    <h2>Редактирование Сферы деятельности ({{\App\Models\LunarDayActivityField::getActivityNameById($lunar_activity_field->id)}}) </h2>
...
{{--                    <button class="btn btn-primary btn-icon float-right right_icon_toggle_btn" type="button"><i class="zmdi zmdi-arrow-right"></i></button>--}}
        ...
        <div class="container-fluid">
            <div class="row">
                <div class="col-lg-12">
                    <form id="lunarFieldOfActivityForm" action="/lunar-activity-field/update/{{$lunar_activity_field->id}}" method="POST">
                        @csrf
                        <div class="card">
                            <div class="body">
                                <div class="">
                                    <label>Название сферы:</label>
                                </div>
...
{{--                                <div class="form-group">--}}
{{--                                    <input name="title" type="text" class="form-control" placeholder="Введите заголовок" value="{{$lunar_activity_field->influence}}" />--}}
{{--                                </div>--}}
    ...
    <script>
        $(document).ready(function() {
            ...
            $('#lunarFieldOfActivityForm').on('submit', function() {
